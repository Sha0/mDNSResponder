...
ERROR(kmDNSHelperDirectoryCreationFailed, "Could not create directory")
ERROR(kmDNSHelperSymlinkFailed, "Could not create symbolic link")
ERROR(kmDNSHelperSetOwnershipFailed, "Could not set file ownership")
