...
public __gc class DNSService
{
public:

	__gc class ServiceRef;

	__value enum ServiceFlags : int
	{
		MoreComing			=	1,
...
mains
	...
	__gc class DNSServiceException
	:
		public Exception
	{
	public:
	 ...
	 */
	__gc class ServiceRef : public IDisposable
	{
	public:
	...
	*/
	static public ServiceRef * CreateConnection();
