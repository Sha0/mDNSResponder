...
#define MASTER_PROD_VERS		1,0,0,61
#define MASTER_PROD_VERS_STR	"1,0,0,61"
#define MASTER_PROD_VERS_STR2	"1.0.0.61"
#define MASTER_PROD_VERS_STR3 "Explorer Plugin 1.0.0.61"
